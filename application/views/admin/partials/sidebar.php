...
<div class="main-sidebar">
    ...
    margin-top: -5%;">
		...
		<ul class="sidebar-menu">
			...
			<li class="<?= ($this->uri->segment('2') == 'syllabus_list') ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url('backend/syllabus_list'); ?>"><i class="fas fa-list"></i> <span>Syllabus List</span></a></li>
