...
<div id="app">
	<div class="main-wrapper main-wrapper-1">
		...
		<!-- Header -->
		<?php $this->load->view('teachers/partials/header'); ?>

		<!-- sidebar -->
		<?php $this->load->view('teachers/partials/sidebar'); ?>
		...
		<!-- footer -->
		<?php $this->load->view('teachers/partials/footer'); ?>

		<!-- language -->
		<?php $this->load->view('teachers/partials/language'); ?>
