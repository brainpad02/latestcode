...
<div class="main-sidebar">
    ...
    margin-top: -5%;">
		...
		<ul class="sidebar-menu">
			...
			<li class="<?= ($this->uri->segment('2') == 'subscription') ? 'active' : '' ?>"><a class="nav-link" href="<?= base_url('teachers/subscription'); ?>"><i class="fas fa-users"></i><span>Subscribe Users</span></a></li>
